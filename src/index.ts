...
const main = async () => {
    ...
    do {
        ...
        switch(n){
            case 1:
                console.log('Vamos a calcular el perímetro y área de un triángulo')
                ...
                lado1 =  parseInt( await leerTeclado('Introduzca un lado del triángulo'))
                lado2 =  parseInt( await leerTeclado('Introduzca el otro lado del triángulo'))
                ...
                break
            case 2:
                console.log('Vamos a calcular el perímetro y área de un cuadrado')
                let lado:number
                ...
                break
            case 3:
                console.log('Vamos a calcular el perímetro y área de un círculo')
                let radio:number
                ...
                break
            case 4:
                console.log('Vamos a calcular el perímetro y área de un rectángulo')
